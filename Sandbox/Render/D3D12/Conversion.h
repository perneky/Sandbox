...
inline DXGI_FORMAT Convert( PixelFormat format )
{
  ...
  case PixelFormat::RGBA8888U:     return DXGI_FORMAT_R8G8B8A8_UINT;
  ...
  case PixelFormat::R32U:          return DXGI_FORMAT_R32_UINT;
  ...
  case PixelFormat::RGB323232F:    return DXGI_FORMAT_R32G32B32_FLOAT;
  case PixelFormat::RGBA32323232F: return DXGI_FORMAT_R32G32B32A32_FLOAT;
  ...
  case PixelFormat::Shadow:        return DXGI_FORMAT_R32_TYPELESS;
...
inline bool IsBlockFormat( PixelFormat format )
{
  switch ( format )
  {
  case PixelFormat::BC1UN:
  case PixelFormat::BC2UN:
  case PixelFormat::BC3UN:
  case PixelFormat::BC4UN:
  case PixelFormat::BC5UN:
    return true;
  default:
    return false;
  }
...
inline int CalcBlockSize( PixelFormat format )
{
  switch ( format )
  {
  case PixelFormat::BC1UN:
