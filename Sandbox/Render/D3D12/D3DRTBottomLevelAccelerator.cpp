...
D3DRTBottomLevelAccelerator::D3DRTBottomLevelAccelerator( D3DDevice& device
                                                        , D3DCommandList& commandList
                                                        , D3DResource& vertexBuffer
                                                        , int vertexCount
                                                        , int positionElementSize
                                                        , int vertexStride
                                                        , D3DResource& indexBuffer
                                                        , int indexSize
                                                        , int indexCount
                                                        , int infoIndex
                                                        , bool opaque
                                                        ...
                                                        , bool fastBuild )
{
  ...
  d3dGeometryDesc.Flags                                = opaque ? D3D12_RAYTRACING_GEOMETRY_FLAG_OPAQUE : D3D12_RAYTRACING_GEOMETRY_FLAG_NONE;
